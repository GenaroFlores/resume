  ...
  res.render('summary', {
    ...
    main: {
      ...
      experience: {
        ...
        or such events like: money line - first win / draw / second win, totals etc.`,
      },
    },
  ...
  res.render('education', {
    ...
    main: {
      ...
      certificates: [
        ...
        {
          name: 'Complete HTML course certificate',
          id: 3717,
        },
        {
          name: 'Hrinchenko University Diploma',
          id: 1132,
        },
      ],
    },
          ...
          projects: [
            {
              ...
              about:
                'Airbnb competitor. High-load apllication for searching appartments',
              ...
              awards: [
                ...
                {
                  name: 'Prepared SEO optimization',
                },
              ],
            },
          ],
...
router.get('/index8', function (req, res) {
  ...
  res.render('index8', {
    ...
    text: 'Hey! Welcome to my first pet-project! Here I worked out HTML, a bit of CSS, Library of UI components Bootstrap and template maker Handlebars. You may check all my developments via button list down below!) ',
    page_list: [
      { name: 'Bio', link: '/bio' },
      ...
      { name: 'index8', link: '/index8' },
      { name: 'Javascript', link: '/js' },
      { name: 'Mac', link: '/mac' },
      { name: 'Person', link: '/person' },
      { name: 'Program', link: '/program' },
      { name: 'Shop cart', link: '/shopcart' },
      { name: 'Shop catalog', link: '/shopcatalog' },
      { name: 'Shop homepage', link: '/shophome' },
      { name: 'Shop news', link: '/shopnews' },
      { name: 'Shop order', link: '/shoporder' },
      { name: 'Shop product', link: '/shopproduct' },
      { name: 'Shop profile', link: '/shopprofile' },
      { name: 'Shop review', link: '/shopreview' },
      { name: 'Skills', link: '/skills' },
      { name: 'Summary', link: '/summary' },
      { name: 'Task 2.1', link: '/task21' },
      { name: 'Task 2.2', link: '/task22' },
      { name: 'Task 3.1', link: '/task31' },
      { name: 'Web', link: '/web' },
      { name: 'Work', link: '/work' },
    ],
  })
